// Ementa Outubro - Familia Goncalves
export const MONTH_NAME = "Outubro"
export const MONTH_INDEX = 10
export const WEEKS = [
  { id: 1, days: [
    {
    ...
    },
    {
      ...
      snack:  { adults: "—", child: "—" },
      soup:   { adults: "—", child: "—" },
      lunch:  { adults: "Caril de Peixe e Camarao com Coco e Abacaxi com Arroz Branco", child: "Caril suave de Peixe com Coco e Arroz (menos especiarias)", cal_adults: "~510 kcal", cal_child: "~370 kcal", note: "Omega-3 + Anti-inflamatorio + Vitamina C" },
  ...
  { id: 2, days: [
    ...
    },
    {
      ...
      snack:  { adults: "—", child: "—" },
      soup:   { adults: "—", child: "—" },
      lunch:  { adults: "Esparguete de Curgete com Lentilha, Salada de Manga e Peixe a Milanesa", child: "Massa Esparguete com Lentilhas e Peixe panado no forno", cal_adults: "~470 kcal", cal_child: "~360 kcal", note: "Fibra + Proteina vegetal + Vitamina C" },
      dinner: { adults: "Jerk Turkey Smashed Plantain Burgers", child: "Peru assado em tiras com Banana-da-Terra", cal_adults: "~390 kcal", cal_child: "~310 kcal", note: "Potassio + Proteina magra" }
    },
    {
      day: "Domingo", short: "Dom",
  ...
  { id: 3, days: [
    ...
    },
    {
      ...
      snack:  { adults: "—", child: "—" },
      soup:   { adults: "—", child: "—" },
      lunch:  { adults: "Frango no Forno com Pure de Mandioquinha e Molho de Manteiga e Salsinha", child: "Frango no Forno com Pure de Mandioquinha e Legumes", cal_adults: "~510 kcal", cal_child: "~370 kcal", note: "Proteina magra + Vitamina C + Antioxidantes" },
      dinner: { adults: "Pao com Ovo na Frigideira", child: "Pao com Ovo estrelado", cal_adults: "~280 kcal", cal_child: "~230 kcal", note: "Proteina + Hidratos" }
    },
    {
      day: "Domingo", short: "Dom",
